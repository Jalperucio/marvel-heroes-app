...
-keepclassmembers class com.hiberus.mobile.android.openbanktest.datasources.marvel.remote.model.** {
  *;
}
-keepclassmembers class com.hiberus.mobile.android.openbanktest.datasources.marvel.memory.model.** {
  *;
}
-keepclassmembers class com.hiberus.mobile.android.openbanktest.datasources.marvel.remote.** {
  *;
}

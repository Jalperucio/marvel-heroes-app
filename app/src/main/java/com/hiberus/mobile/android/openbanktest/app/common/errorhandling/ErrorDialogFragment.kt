...
import com.hiberus.mobile.android.openbanktest.app.common.util.ResourceUtils
...
class ErrorDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val errorCode = getString(
            R.string.error_support_code,
            errorMessageForDialog.actionCode.toString() + "/" + errorMessageForDialog.errorCode
        )
